	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<li><a href="/todo"><i class="fa fa-check"></i><span>Data Todo</span></a></li>	
				<li><a href="/category"><i class="fa fa-bars"></i><span>Data Category</span></a></li>	
				<li><a href="/user"><i class="fa fa-user"></i><span>Data User</span></a></li>	
			</ul>
		</section>
	<!-- /.sidebar -->
	</aside>
